          ...
          {localRemType === "mixte" && (
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-muted-foreground">Répartition salaire / dividendes</span>
          ...
          {results.map((r) => {
            ...
            return (
              <div
                key={r.status}
                className={cn(
                  "bg-card rounded-2xl border p-5 transition-all relative",
                  r.ineligible
              ...
              >
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium text-foreground">{fmt(r.chargesSociales / 12)} &euro;</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 text-muted-foreground">
                    ...
                    <span className="font-medium text-foreground">{fmt(r.impots / 12)} &euro;</span>
                  </div>
