        ...
        if (data.clients && data.clients.length > 0) {
          const dbClients: ClientData[] = data.clients.map(
            (c: Record<string, unknown>, i: number) => ({
              ...
              startYear: (c.startYear as number) ?? undefined,
              endYear: (c.endYear as number) ?? undefined,
              ...
              siren: (c.siren as string) ?? undefined,
              tvaNumber: (c.tvaNumber as string) ?? undefined,
              nafCode: (c.nafCode as string) ?? undefined,
              legalForm: (c.legalForm as string) ?? undefined,
              ...
              clientCountry: (c.clientCountry as string) ?? undefined,
              website: (c.website as string) ?? undefined,
              paymentTermDays: (c.paymentTermDays as number) ?? undefined,
            })
          );
