      ...
      <div className="flex items-center justify-between mb-1">
        ...
        <div className="flex gap-4 text-xs">
          ...
          <span className="flex items-center gap-1.5">
            ...
            <span className="text-muted-foreground">Simulé</span>
          </span>
        </div>
      </div>
      ...
      <ResponsiveContainer width="100%" height={280}>
        <AreaChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
          ...
          <Area
            ...
            activeDot={{ r: 5, fill: "#5682F2", stroke: "var(--card)", strokeWidth: 2 }}
          />
          <Area
            type="monotone"
            dataKey="simule"
            ...
            activeDot={{ r: 5, fill: "#F4BE7E", stroke: "var(--card)", strokeWidth: 2 }}
          />
        </AreaChart>
      </ResponsiveContainer>
    </div>
